...
const categories = [
  ...
  { name: 'Medicine', emoji: '💊', count: 24, tag: 'Daily Fresh', accent: '#60a5fa', bg: '#172554', homeCategory: 'Medicine' },
  { name: 'Others', emoji: '📦', count: 24, tag: 'Daily Fresh', accent: '#60a5fa', bg: '#172554', homeCategory: 'Others' },
];
